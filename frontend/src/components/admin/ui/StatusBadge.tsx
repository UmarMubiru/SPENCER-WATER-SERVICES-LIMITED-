...
const STYLES: Record<string, string> = {
  ...
  FULL_TIME: "bg-blue-50 text-blue-700 ring-1 ring-inset ring-blue-200",
  PART_TIME: "bg-blue-200 text-blue-900 ring-1 ring-inset ring-blue-300",
  CONTRACT: "bg-blue-100 text-blue-800 ring-1 ring-inset ring-blue-300",
};
