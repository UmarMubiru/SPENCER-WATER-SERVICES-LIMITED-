...
export default function EditEmployeePage() {
  ...
  const fetchData = async () => {
    try {
      const [employeeData, departmentsData] = await Promise.all([
        employeeService.getEmployee(Number(params.id)),
      ...
      setFormData({
        ...
        job_title: employeeData.job_title_name || '',
        employment_type: employeeData.employment_type_name || '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await employeeService.updateEmployee(Number(params.id), formData);
      router.push(`/admin/employees/details/${params.id}`);
    } catch (error) {
          ...
          <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between">
                ...
                <Link href={`/admin/employees/details/${params.id}`} className="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors">
                  Cancel
                </Link>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="p-6">
              ...
              <div className="mt-6 flex justify-end gap-3">
                <Link
                  href={`/admin/employees/details/${params.id}`}
