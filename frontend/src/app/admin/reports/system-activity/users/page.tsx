...
export default function UsersActivityPage() {
  ...
  const getActionColor = (action: string) => {
    const colors: Record<string, string> = {
      ...
      permission_update: 'bg-pink-100 text-pink-800',
  ...
  return (
    <AdminLayout
      ...
      subtitle="Audit log for user management activities"
      ...
      <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              >
                ...
                <option value="permission_update">Permission Updated</option>
        ...
        <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
          <div className="border-b border-gray-200 px-4 py-2.5 flex items-center justify-between bg-gray-50">
            <h3 className="font-semibold text-gray-900 text-base">User Activities</h3>
