...
export default function EmploymentActivityPage() {
  ...
  const fetchActivities = async () => {
    ...
    try {
      ...
      params.append('module', 'employment');
  ...
  const getActionColor = (action: string) => {
    const colors: Record<string, string> = {
      ...
      renew: 'bg-pink-100 text-pink-800',
  ...
  return (
    <AdminLayout
      title="Employment Management Activity"
      subtitle="Audit log for employment-related activities"
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
          <div className="border-b border-gray-200 px-4 py-2.5 flex items-center justify-between bg-gray-50">
            <h3 className="font-semibold text-gray-900 text-base">Employment Activities</h3>
