...
export default function ContentActivityPage() {
  ...
  return (
    <AdminLayout
      ...
      subtitle="Audit log for content management activities"
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
          <div className="border-b border-gray-200 px-4 py-2.5 flex items-center justify-between bg-gray-50">
            <h3 className="font-semibold text-gray-900 text-base">Content Activities</h3>
